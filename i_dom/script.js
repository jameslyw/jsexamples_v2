...
const spanInputs = [
    "Properties of the DOM.", "Methods of the DOM."
]
//how many span elements are there and what is the starting index?
...
// * . - querySelector regonizes a class
...
inputTxt.value = "Text input - input selector"
...
// todo: set the bar to 100% according to screenwidth

const menuTitles = ["Welcome", "home", "About", "contact"];

menuTitles.forEach((title, index) => {

    // create a list item to appen (as a child) to the unordered list
